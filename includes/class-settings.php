            ...
            <form method="post" action="">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="excluded_paths" rows="5" cols="50" class="large-text"><?php echo esc_textarea($excluded_paths); ?></textarea>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="cookie_notice_text" rows="3" cols="50" class="large-text"><?php echo esc_textarea($cookie_notice_text); ?></textarea>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="excluded_php_paths" rows="5" cols="50" class="large-text"><?php echo esc_textarea($excluded_php_paths); ?></textarea>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="blocked_patterns" rows="5" cols="50" class="large-text"><?php echo esc_textarea($blocked_patterns); ?></textarea>
